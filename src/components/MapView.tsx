...
const latLngToPixel = (lat: number, lng: number, bounds: any) => {
...
export function MapView({ resources, filter, onResourceClick }: MapViewProps) {
  const [selectedMarker, setSelectedMarker] = useState<Resource | null>(null);
